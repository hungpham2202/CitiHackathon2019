          ...
          <Row noGutters>
            <Col md={4}>
              <div style={{ width: "90%", backgroundColor: "#fff", paddingTop: "50px", paddingBottom: "50px", paddingLeft: "10px", boxShadow: "0px  3px  8px #888" }} >
                <div className="pb-4">
                  <h3 className="pb-4">My Profile </h3>
                  ...
                  <h5>{this.state.userProfile.accountType}</h5>
                  <h5>{this.state.userProfile.emailAddress}</h5>
                  <h5>{this.state.userProfile.organisationName}</h5>
                </div>
                <ButtonToolbar>
